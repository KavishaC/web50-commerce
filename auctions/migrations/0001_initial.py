    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.URLField(blank='True', max_length=400)),
                ('status', models.CharField(choices=[('1', 'Active'), ('2', 'Closed')], default='1', max_length=1)),
                ...
                ('lister', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='listings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
